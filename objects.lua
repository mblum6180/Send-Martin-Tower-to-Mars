...
objects.ground = {}
objects.ground.body = love.physics.newBody(world, system.winWidth/2, love.graphics.getPixelHeight() - 75)
...
objects.tower.body = love.physics.newBody(world, love.math.random(0, system.winWidth), 0, "dynamic")
